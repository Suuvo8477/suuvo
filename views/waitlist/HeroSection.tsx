      ...
      <section id='home' className='pt-24 sm:pt-30 md:pt-38 relative z-10 overflow-hidden bg-[#FEF9F7] h-auto'>
        ...
        <div className='s-container h-full'>
          <div className='flex flex-col md:flex-row md:justify-between md:items-stretch gap-8 md:gap-12 h-full'>
            {/* Left - Heading */}
            <div className='w-full md:max-w-1/2 md:flex-1 md:pb-31.5'>
              <Typography variant='h2' className='max-w-130.5'>
                Reserve Your Suuvo Username
              </Typography>
              <Typography variant='p3' className='mt-4 md:mt-5 lg:mt-6 mb-6'>
              ...
              <ul className='flex items-center gap-4 mb-8 md:mb-18 flex-wrap'>
              ...
              <div className='p-8 bg-white max-w-127 shadow-[0px_7px_15px_0px_#0000000A,7px_0px_15px_0px_#0000000A,0px_27px_27px_0px_#00000008,0px_60px_36px_0px_#00000005,0px_106px_42px_0px_#00000003,0px_166px_46px_0px_#00000000] rounded-[20px]'>
                <div className='flex items-center gap-4 mb-6'>
                  ...
                  <div>
                    ...
                    <Typography variant='p3'>Reserve your username early.</Typography>
                  </div>
                </div>
            ...
            <div className='relative w-full h-72 sm:h-96 md:h-auto md:flex-1 md:max-w-1/2 md:self-stretch'>
              <Image
